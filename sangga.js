...
function viewSangga(){
  ...
  html+=`<div style="text-align:center;color:var(--muted);font-size:11px;font-weight:600;margin:10px 0 18px">상가 관리 · v0817.5</div>`;
  return html;
}
...
window.SanggaMgr={S,ledgerBalance,activeLease,currentStatus,calcAcq,giftTaxGross,phoneFmt};
})();
